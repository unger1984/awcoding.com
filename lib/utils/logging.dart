...
class Logging {
  static void _multiline(Object? obj, Styles style, {String? startText, String? endText}) {
    if (obj == null) return;
  ...
  static void setupLogging() {
    ...
    Logger.root.onRecord.listen((record) {
      ...
      _multiline(record.error, front);
      _multiline(record.stackTrace, front, startText: '=== STACK ===');
    });
  }
}
